...
Date = pd.read_csv('E:/pycharmProjects/py_Gender/A9SRAFconPlot/merged_file1.csv', header=None)
...
pic = sns.boxplot(x=Date.iloc[:, 16], y=Date.iloc[:, 9], data=Date, ax=ax[1, 2], linewidth=0.8, palette=flatui,legend=False,fliersize=0, width=0.7, saturation=6)
# 设置坐标轴范围
